                                ...
                                <div className="p-4" style={{backgroundColor: 'rgba(0, 0, 0, 0.80)', display:'block'}}>
                                    <div className="d-flex h-100">
                                        <div className="d-flex flex-column justify-content-center mr-4">
                                            <img src={posterUrl} alt={movie.title} style={{minWidth:'50%'}}/>
                                        </div>
                                        <div className="d-flex flex-column justify-content-start">
                                            ...
                                            <div className="d-flex flex-column justify-content-between h-100">
                                                ...
                                                <div className="info d-flex justify-content-between align-content-between">
                                                    <div className="releaseDate">
                                                        <h4 className="lead text-muted">Release Date</h4>
                                                        <p className="text-muted mb-0">{movie.release_date}</p>
                                                    </div>
                                                    <div className="score d-flex flex-column justify-content-center align-items-center" style={scoreStyle}>
